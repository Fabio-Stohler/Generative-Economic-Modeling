# %% [markdown]
"""
# Brock–Mirman Surrogate Analysis (Colab)

Run the setup cell below once per Colab session to install this repo as a package.
After setup, you can rerun the rest of the notebook without reinstalling.
"""

# %%
!pip install -q git+https://github.com/Fabio-Stohler/Generative-Economic-Modeling.git
